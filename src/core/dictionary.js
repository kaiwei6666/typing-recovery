// Generated by scripts/build-dictionary.cjs; do not edit by hand.
...
globalThis.ZHUYIN_DICTIONARY = Object.freeze({
  ...
  "ㄅㄚˋ": "罷爸霸壩耙弝灞伯猈把",
  "ㄅㄚ˙": "吧罷琶杷爸巴",
  "ㄅㄛ": "玻撥剝菠缽嶓砵播般碆袚襏鱍啵柭蹳岥蔔波",
  "ㄅㄛˇ": "跛簸蚾",
  "ㄅㄛˊ": "伯博柏泊勃搏渤駁白薄脖帛舶箔荸蔔膊鈸餑鉑欂鵓踣浡襮踄鎛駮僰餺髆桲謈檗馞胉挬猼葧鋍懪簙礴礡鑮郣鸔糪",
  "ㄅㄛˋ": "播擘簸亳薜譒薄檗蘗繴挀",
  "ㄅㄛ˙": "蔔",
  "ㄅㄞ": "掰",
  "ㄅㄞˇ": "百擺佰襬粨捭矲絔",
  ...
  "ㄆㄧˇ": "否匹疋痞嚭苤仳庀圮崥諀癖",
  "ㄆㄧˊ": "皮疲脾琵枇裨啤毗埤沘貔陂羆罷紕郫陴鼙鈹膍毘阰蚽蜱玭笓鈚錍魾螷犤毞猈藣蠯蚍比",
  "ㄆㄧˋ": "譬闢僻媲屁辟癖甓擗澼濞淠揊潎鷿髲礔埤",
  "ㄆㄧㄝ": "瞥撇氕",
  "ㄆㄧㄝˇ": "撇",
  "ㄆㄧㄠ": "飄漂慓螵薸僄旚翲魒",
  "ㄆㄧㄠˇ": "漂莩縹瞟殍皫摽醥犥鷅",
  ...
  "ㄇㄛˇ": "抹",
  "ㄇㄛˊ": "模磨摩膜糢魔摹謨蘑劘嫫藦髍摸麼",
  "ㄇㄛˋ": "末莫默漠沒膜寞陌歿脈沫秣茉驀墨貊磨瘼靺歾饃鄚纆霢嚜眽瞙藦暯枺爅妺万銆鏌貘粖蛨袹嗼塻慔蟔鬕莈覛縸嘜魩",
  "ㄇㄛ˙": "麼",
  "ㄇㄜ˙": "麼",
  "ㄇㄞˇ": "買嘪鷶",
  "ㄇㄞˊ": "埋霾薶",
  "ㄇㄞˋ": "賣麥邁脈勱蝐",
  "ㄇㄟˇ": "美每鎂浼媺渼媄挴燘",
  "ㄇㄟˊ": "沒煤眉枚梅媒莓霉玫黴酶楣湄嵋苺禖郿堳瑂脢鋂呅腜塺徾攗槑",
  "ㄇㄟˋ": "妹媚寐昧眛魅瑁沬袂痗韎煝蝞",
  "ㄇㄟ˙": "妹",
  "ㄇㄠ": "貓",
  "ㄇㄠˇ": "卯昴泖茆",
  ...
  "ㄈㄨˇ": "府腐撫輔甫斧俯釜脯腑莆滏拊黼簠頫郙弣鯆暊冹蜅蚥軵父",
  "ㄈㄨˊ": "服福扶浮符伏彿縛幅俘拂苻弗孚袱芙輻蝠匐蜉罘涪夫郛莩怫蚨桴紼茯菔紱咈洑綍艴芾茀艀刜帗笰葍袚氟棴澓烰枹玸岪枎垘昲柫琈虙踾鳧巿沷祓翇韍諨鴔黻鵩鶝沸",
  "ㄈㄨˋ": "父負婦付附富復副傅覆複腹咐赴賦駙阜訃馥賻蝮鮒祔偩輹鰒鍑榑复胕蚹萯蝜褔姇峊蛗緮蕧",
  "ㄈㄨ˙": "夫",
  "ㄉㄚ": "搭褡答撘瘩躂咑耷",
  "ㄉㄚˇ": "打",
  "ㄉㄚˊ": "答達韃靼瘩怛繨噠妲笪荅薘褟鐽匒呾畣炟鎝打",
  "ㄉㄚˋ": "大",
  "ㄉㄜˊ": "得德淂",
  "ㄉㄜ˙": "的得地",
  "ㄉㄞ": "呆待獃",
  ...
  "ㄉㄡ": "都兜郖",
  "ㄉㄡˇ": "斗抖陡蚪枓唗敨",
  "ㄉㄡˋ": "鬥豆逗痘竇荳脰餖鋀梪浢讀闘鬦鬪鬬鬭",
  "ㄉㄢ": "單擔丹耽簞鄲眈聃酖砃甔襌匰聸勯嚪殫",
  "ㄉㄢˇ": "膽疸撢亶紞刐撣玬衴黵丼澸",
  ...
  "ㄉㄧˊ": "的敵迪狄笛滌翟荻嫡嘀鏑蹢犒糴覿篴蔋靮梑潪苖嚁鸐藋藡",
  "ㄉㄧˋ": "地第弟帝遞蒂的締諦娣睇棣杕玓禘蔕螮踶楴渧碲虳釱樀旳軑梊焍馰墆嵽珶甋坔",
  "ㄉㄧ˙": "地弟",
  "ㄉㄧㄚ": "嗲",
  "ㄉㄧㄝ": "爹",
  ...
  "ㄊㄚ": "它他她牠塌褟祂禢",
  "ㄊㄚˇ": "塔榙鎝",
  "ㄊㄚˋ": "踏榻蹋塌獺搨遢嚃躂沓嗒撻遝闥鎉闒錔鞜鞳鰨羍涾傝毾誻鑉漯迖濌龘拓",
  "ㄊㄚ˙": "遢",
  "ㄊㄜˋ": "特慝忒忑鋱貣蟘",
  "ㄊㄞ": "胎苔",
  ...
  "ㄋㄥˊ": "能薴儜",
  "ㄋㄥˋ": "濘",
  "ㄋㄧˇ": "你妳擬禰儗旎昵坭柅薿檷抳苨馜隬譺祢",
  "ㄋㄧˊ": "泥尼妮倪霓怩猊蜺輗郳麑鯢齯臡秜狋觬婗淣呢狔屔跜鈮鶂兒",
  "ㄋㄧˋ": "逆溺匿膩泥睨暱惄鷁鷊嫟縌迡堄",
  "ㄋㄧㄝ": "捏踗鑈",
  "ㄋㄧㄝˊ": "苶",
  "ㄋㄧㄝˋ": "孽鎳躡聶鑷涅囁囓臬乜嚙臲闑隉齧敜顳糱蘗疌嵲踂篞櫱蠥钀巕摰",
  "ㄋㄧㄠˇ": "鳥裊嬲嬝嫋蔦褭",
  "ㄋㄧㄠˋ": "尿",
  "ㄋㄧㄡ": "妞",
  "ㄋㄧㄡˇ": "紐扭鈕忸狃炄莥",
  ...
  "ㄌㄧˋ": "力立利麗歷壢例曆莉厲勵礪粒蒞靂瀝儷隸礫吏荔栗慄俐痢癘笠戾唳酈琍詈嚦溧蠣櫪沴糲櫟轢瓅鬁猁盭篥苙唎屴躒鬲皪秝瑮轣岦朸欐禲赲鴗砅濿砬悷蚸厤筣綟蜧磿斄犡藶蠫鷅麜攦觻鷑攭鱳靋栵浰塛搮蝷儮曞讈瓥鱱娳",
  "ㄌㄧ˙": "哩",
  "ㄌㄧㄚˇ": "倆",
  "ㄌㄧㄝ": "咧",
  "ㄌㄧㄝˇ": "咧",
  ...
  "ㄌㄧㄥ": "拎",
  "ㄌㄧㄥˇ": "領嶺彾",
  "ㄌㄧㄥˊ": "零玲靈鈴齡陵凌菱聆羚苓伶綾淩翎鴒囹蛉瓴泠舲酃軨錂櫺柃欞睖砱詅輘霝鯪醽岭昤澪呬坽夌姈狑皊呤琌笭裬蘦怜婈駖蕶爧堎〇",
  "ㄌㄧㄥˋ": "令另炩",
  "ㄌㄨ": "嚕擼",
  "ㄌㄨˇ": "魯虜擄滷鹵櫓艣磠鐪鏀蓾擼氌",
  ...
  "ㄏㄥˊ": "橫恆衡恒珩蘅桁鴴姮鑅楻誙諻揘佷",
  "ㄏㄥˋ": "橫啈澋絎",
  "ㄏㄨ": "忽呼乎惚滹戲猢欻膴虖吰虍幠寣昒歑烼垀曶啒峘淴謼匢淲糊虎",
  "ㄏㄨˇ": "虎琥滸唬許汻",
  "ㄏㄨˊ": "胡湖壺蝴糊狐弧葫鬍瑚餬斛鵠囫縠衚觳醐猢搰鶘槲媩抇鰗焀魱螜瀫楜嘝鶦鶻",
  "ㄏㄨˋ": "護戶互滬扈瓠怙祜笏冱戽楛沍岵鄠臛頀枑槴昈嫭婟嫮熩豰綔謢蔰糊",
  "ㄏㄨㄚ": "花華嘩鷨錵化",
  "ㄏㄨㄚˊ": "華滑划猾譁嘩樺驊鏵豁劃崋釫螖",
  ...
  "ㄐㄧㄚ": "家加嘉佳傢迦枷袈痂笳珈跏茄葭豭耞麚泇毠鎵鴐猳幏犌貑夾伽",
  "ㄐㄧㄚˇ": "假甲賈鉀岬胛斝榎瘕檟婽玾徦椵夏舺",
  ...
  "ㄐㄧㄠˇ": "腳角繳攪勦矯絞姣佼餃皎僥剿較鉸狡皦儌筊蟜摷撟捁灚曒漅劋譑煍徼",
  "ㄐㄧㄠˊ": "嚼",
  "ㄐㄧㄠˋ": "教叫校較覺轎窖皭醮徼噭嶠挍斠珓釂滘窌嘂潐譥",
  "ㄐㄧㄡ": "糾揪啾鳩轇湫樛揫勼朻牞觓揂萛鬮赳",
  "ㄐㄧㄡˇ": "九久酒玖赳灸韭糾",
  ...
  "ㄐㄧㄥˇ": "景警井頸阱儆璟憬剄璥丼憼暻蟼燛",
  "ㄐㄧㄥˋ": "敬竟鏡靜境淨競逕徑靖勁凊脛痙獍倞靚竫婧桱俓凈葝擏弳",
  "ㄐㄩ": "居拘駒沮疽蛆狙俱車据鋸裾苴趄罝菹娵椐腒崌痀琚雎涺葅鮈鶋斪揟蜛踙輋",
  "ㄐㄩˇ": "舉矩咀莒沮齟櫸筥踽蒟椇柜竘袓跙蝺",
  "ㄐㄩˊ": "局鞠菊橘掬跼桔挶鞫侷匊踘鋦鵙鶪椈焗淗驧狊梮郹犑輂箤趜鵴蘜鼳陱駶鴃",
  "ㄐㄩˋ": "據句具巨劇聚俱拒距鋸懼鉅炬詎遽倨瞿踞颶泃苣窶醵屨秬虡寠鐻佢据粔姖怚絇足耟岠埧蚷駏澽貗躆洰焣壉犋沮",
  "ㄐㄩㄝ": "噘嗟撅",
  "ㄐㄩㄝˇ": "蹶",
  ...
  "ㄐㄩㄥ": "扃坰駉",
  "ㄐㄩㄥˇ": "窘迥煚泂炅絅褧冏熲囧皛炯幜顈",
  "ㄑㄧ": "七妻欺戚漆棲悽淒柒萋慼溪沏諆郪娸鸂嘁顣悊榿磎倛咠栖谿凄唭徛桼僛緀磩霋魌鶈攲槭",
  ...
  "ㄑㄧㄢ": "千鉛遷簽牽謙籤嵌仟阡韆騫愆僉慳搴褰粁岍汧縴芊掔扦檶鐱婜攐攓譣顩奷忏顅麉櫏",
  "ㄑㄧㄢˇ": "遣淺譴繾槏撖忏蜸潛嗛",
  "ㄑㄧㄢˊ": "前錢乾潛黔鉗虔箝鈐掮媊揵燂拑鬵灊黚忴扲岒漧葥鳹騚鰬仱姏蚙軡榩",
  "ㄑㄧㄢˋ": "欠歉倩慊茜塹芡傔嗛槧縴篟綪棈蒨輤嵌",
  "ㄑㄧㄣ": "親侵欽衾駸嶔綅瀙鋟",
  "ㄑㄧㄣˇ": "寢昑寑曋螼坅顉",
  ...
  "ㄒㄧ": "西希吸攜嘻犧稀悉溪析蟋熙禧膝棲釐嬉兮犀晰羲畦曦僖蜥扱熹奚盻觿譆晞欷蹊樨巇淅皙唏烯傒徯恓窸粞豨醯鼷氥浠潝燨瓗疧酅媐巂悕睎硒蠵鑴榽歖爔琋螇俙徆怷娭屖谿莃菥僁橀螝豯貕鵗騱驨郋桸惁凞闟誒礂螅",
  ...
  "ㄒㄧㄝˋ": "謝械洩屑瀉懈卸泄蟹解屜褻榭契駭廨渫邂燮楔絏薤紲媟嶰澥瀣獬躞灺疶鞢骱駴偰檞齘伳妎祄榍韰屧焎揳齥躠寫",
  "ㄒㄧㄝ˙": "謝",
  ...
  "ㄒㄧㄡˇ": "朽宿糔",
  "ㄒㄧㄡˋ": "秀繡鏽袖嗅宿臭銹琇溴岫珛玊殠褎螑綉",
  "ㄒㄧㄢ": "先仙掀鮮纖暹姍孅憸躚銛秈韱枮氙馦嬐仚屳奾杴忺澖灦祆僊嘕蓒褼廯襳珗",
  "ㄒㄧㄢˇ": "險顯鮮癬蘚銑燹跣嶮蜆姺尟幰獫獮玁筅韅毨烍鍌搟鼸齴赻攇禒洗",
  "ㄒㄧㄢˊ": "賢閒嫌咸鹹弦銜絃嫻嫺涎啣舷閑癇諴蚿憪鷴娹葴胘蛝羬燅礥鷳唌",
  "ㄒㄧㄢˋ": "縣現線限憲獻羨陷腺餡蜆莧霰俔僩峴晛睍豏轞鋧涀瀗粯娊撊錎姭見",
  ...
  "ㄒㄧㄥˋ": "行興性幸姓杏倖悻荇婞莕涬",
  "ㄒㄩ": "須需虛鬚噓墟戌胥訏吁歔盱嬃繻殈旴楈嬬鑐欨倠稰縃蝑蕦驉魖晇幁揟糈",
  "ㄒㄩˇ": "許栩煦咻詡冔姁湑諝醑鄦珝喣呴眭",
  "ㄒㄩˊ": "徐",
  ...
  "ㄒㄩㄥˊ": "雄熊赨",
  "ㄒㄩㄥˋ": "敻詗",
  "ㄓ": "之知隻織支枝汁只吱芝脂肢蜘祇梔祗氏枳胝鴟卮搘秖跖泜鳷汥秪榰胑衼椥",
  ...
  "ㄓㄡˇ": "帚肘睭鯞",
  "ㄓㄡˊ": "軸妯",
  "ㄓㄡˋ": "晝皺宙紂縐冑咒繇甃籀咮酎僽怞胄噣駎葤",
  "ㄓㄢ": "詹沾瞻氈霑旃譫鱣覘邅栴鸇驙占呫饘鉆詀薝譠",
  "ㄓㄢˇ": "展斬盞輾搌嶄琖魙醆颭樿皽蹍嫸榐橏",
  "ㄓㄢˋ": "佔戰站暫占棧顫湛綻蹔蘸虥轏輚偡",
  "ㄓㄣ": "真針珍貞偵禎斟箴砧甄臻楨榛診蓁獉溱碪胗鍼鱵媜駗薽禛樼潧瑊遉寊蒧轃籈鷏堻𡻈",
  "ㄓㄣˇ": "診枕疹軫畛袗縝稹紾鬒眕黰辴抮抌笉絼祳晸縥黕",
  "ㄓㄣˋ": "鎮陣振震賑朕枕鴆揕酖眹娠侲挋栚蜄桭誫敶圳",
  ...
  "ㄓㄨˋ": "住著助注祝駐註柱蛀鑄炷苧佇箸杼紵翥宁柷羜馵疰莇鉒紸嵀跓軴樦麆櫡殶諔着",
  "ㄓㄨㄚ": "抓撾髽檛",
  "ㄓㄨㄚˇ": "爪",
  "ㄓㄨㄛ": "捉桌涿棹穛",
  "ㄓㄨㄛˊ": "卓茁濁拙濯酌灼著啄鐲擢琢諑倬斲斮梲椓焯蝃踔鷟彴汋斫禚篧浞棳謶錣啅罬斀蠗圴剢灂着",
  "ㄓㄨㄞ": "拽",
  "ㄓㄨㄞˇ": "跩",
  "ㄓㄨㄞˋ": "拽",
  "ㄓㄨㄟ": "追錐椎隹騅鵻腄鴭",
  ...
  "ㄓㄨㄥˇ": "種腫塚踵冢",
  "ㄓㄨㄥˋ": "中種重仲眾尰湩狆衶偅堹緟",
  "ㄔ": "吃蚩癡痴嗤喫郗魑笞絺鴟媸摛瓻螭眵齝离貾誺瞝齹黐麶",
  "ㄔˇ": "尺齒恥呎侈褫欼搋蚇恀拸姼傂誃鉹伬鶒豉",
  "ㄔˊ": "持池遲馳匙弛墀坻踟箎茬蚳篪蚔茌痄忯汦荎栘歭耛貾趍箈徲謘徥",
  "ㄔˋ": "赤翅斥飭叱熾啻傺敕眙抶饎栻遫彳跮踅鷘乿瘛鉓哧淔痸懘戠",
  "ㄔㄚ": "差插叉喳艖嗏扠杈偛疀鎈",
  "ㄔㄚˇ": "蹅",
  "ㄔㄚˊ": "查察茶搽槎鍤碴臿垞秅茬",
  "ㄔㄚˋ": "詫岔剎差汊衩蜡侘奼紁",
  ...
  "ㄕㄣ": "身深伸申紳呻信參蔘娠莘甡侁籸葠詵駪燊砷柛氠屾珅胂阠妽峷眒鯓",
  "ㄕㄣˇ": "沈審嬸瀋諗讅矧哂寀瞫邥覾",
  "ㄕㄣˊ": "神甚什",
  "ㄕㄣˋ": "慎腎滲甚蜃沁葚椹脤抻侺鋠",
  "ㄕㄣ˙": "嬸",
  ...
  "ㄖㄨㄣˋ": "潤閏橍",
  "ㄖㄨㄥˇ": "冗茸氄傇軵",
  "ㄖㄨㄥˊ": "容榮融溶絨熔戎蓉鎔茸榕羢嶸瑢肜毧狨瀜茙烿蠑爃媶榵褣駥髶鰫鷛嫆",
  "ㄗ": "資茲滋吱姿咨孜諮貲輜淄齜緇孳粢髭嵫菑鎡鶿鼒孖澬甾鄑鯔錙趑椔鈭鶅齍栥紎崰秶蠀齊",
  "ㄗˇ": "子仔紫梓籽滓耔訾笫秭胏茈吇杍芓呰矷釨訿姊",
  "ㄗˋ": "自字恣漬眥孳剚胔胾扻倳牸",
  "ㄗ˙": "子",
  "ㄗㄚ": "紮匝咂唼嘁抸鉔",
  "ㄗㄚˊ": "雜咱砸偺雥磼",
  ...
  "ㄘㄨㄥˊ": "從叢淙琮悰潀漎賨錝婃孮徖慒",
  "ㄘㄨㄥˋ": "欉藂謥",
  "ㄙ": "司思斯絲私撕廝鷥嘶澌緦偲罳颸禠虒楒鍶凘泀蕬鉰俬覗榹禗蜤磃謕蟴鷈鼶螄",
  "ㄙˇ": "死",
  "ㄙˋ": "四似賜嗣飼寺肆祀食俟伺泗巳耜儩姒笥駟兕涘柶汜肂貄蕼洍亖",
  "ㄙ˙": "思",
  "ㄙㄚ": "撒仨",
  "ㄙㄚˇ": "灑撒靸洒",
  "ㄙㄚˋ": "薩卅趿颯攃馺隡",
  ...
  "ㄜˋ": "惡餓俄鄂厄遏鍔扼鱷顎呃愕噩軛阨鶚堊諤萼咢啞崿搤詻閼頞堨齶枙堮岋鑩櫮砐砨蚅豟軶圔搹蝁嶭餩蘁砈",
  "ㄝˋ": "誒",
  "ㄞ": "挨哀埃唉哎誒欸",
  "ㄞˇ": "矮藹靄欸毐昹佁",
  "ㄞˊ": "捱皚騃敳癌呆",
  ...
  "ㄦˊ": "兒而洏耏胹輀侕栭陑鮞檽聏荋唲鴯",
  "ㄦˋ": "二貳佴刵咡樲聏毦眲衈弍",
  "ㄧ": "一壹衣依醫伊揖噫漪猗咿禕繄黟曀銥泆鷖欹郼圪溰稦燚洢陭蛜嫛瑿檹毉黳嶬弌",
  "ㄧˇ": "以已乙倚椅矣蟻尾艤迤苡偯扆旖螘扡酏鳦釔齮顗檥鉯迆胣礒掜陭崺晲轙",
  "ㄧˊ": "遺疑移宜怡姨儀夷一誼胰貽飴咦詒沂頤彞迤椸痍蛇圯嶷桋匜宧洟簃訑貤迻杝柂袲酏峓眱羠鈶寲侇珆衪銕呲恞萓沶栘瓵袘羡蛦暆跠歋熪箷螔顊謻觺鸃",
  ...
  "ㄧㄝˇ": "也野冶埜漜",
  "ㄧㄝˊ": "爺耶椰琊揶擨",
  "ㄧㄝˋ": "業葉頁夜咽謁拽靨鄴燁瞱擫射曄饁煠鍱鐷澲鎑偞殗嶪擛液腋",
  "ㄧㄞˊ": "崖睚啀娾",
  "ㄧㄠ": "要腰夭妖邀么吆喲喓祅葽訞",
  ...
  "ㄧㄥˋ": "應硬映媵瀅鎣摬賏",
  "ㄨ": "屋烏污汙圬誣嗚巫鎢鄔洿歍惡於杇陓剭窏腛鴮螐",
  "ㄨˇ": "五午武舞侮伍鵡嘸憮嫵潕廡仵忤碔甒摀啎捂嵨玝倵橆躌",
  "ㄨˊ": "無吳吾梧巫蕪唔蜈誣毋亡牾膴麌鼯郚鋘鋙峿浯珸俉鯃莁鷡洖瞴譕嘸",
  ...
  "ㄨㄟˇ": "委尾偉緯萎諉葦痿猥煒亹隗娓韙寪洧瑋薳蘤韡鮪磈蒍頠暐痏骫椲浘艉芛鍡峗壝喡徫腲蜲儰蓶崣硊踓斖唯",
  ...
  "ㄩㄝ": "約曰噦箹焥",
  "ㄩㄝˋ": "月越樂悅閱粵躍岳嶽耀鑰曜鉞說刖瀹籥樾爚礿禴趯軏鸑龠狘玥戉泧鈅抈蚎蘥鸙",
